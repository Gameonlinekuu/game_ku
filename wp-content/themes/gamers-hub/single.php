	...
	<main id="tp_content" role="main">
		...
		<div class="container">
			<div id="primary" class="content-area">
				<?php
		        $gamers_hub_sidebar_single_post_layout = get_theme_mod( 'gamers_hub_sidebar_single_post_layout','right');
		        if($gamers_hub_sidebar_single_post_layout == 'left'){ ?>
			        <div class="row">
			    ...
			    <?php }else if($gamers_hub_sidebar_single_post_layout == 'right'){ ?>
			        <div class="row">
			          	<div class="col-lg-8 col-md-8">	           
				            <?php
								/* Start the Loop */
			    ...
			    <?php }else if($gamers_hub_sidebar_single_post_layout == 'full'){ ?>
			        <div class="full">
			           <?php
							/* Start the Loop */
							while ( have_posts() ) : the_post();
