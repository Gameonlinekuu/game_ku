<?php
	...
	if($gamers_hub_tp_color_option != false){
		$gamers_hub_tp_theme_css .='#theme-sidebar button[type="submit"], #footer button[type="submit"],.prev.page-numbers, .next.page-numbers,.page-numbers,#comments input[type="submit"],.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt,span.meta-nav ,#theme-sidebar .tagcloud a:hover, .log-btn a , .site-info,.more-btn a, #static-blog .fund-box h5 a,a.added_to_cart.wc-forward ,#slider .carousel-control-prev-icon:hover, #slider .carousel-control-next-icon:hover,.error-404 [type="submit"] {';
			$gamers_hub_tp_theme_css .='background-color: '.esc_attr($gamers_hub_tp_color_option).';';
		$gamers_hub_tp_theme_css .='}';
	}
	if($gamers_hub_tp_color_option != false){
		$gamers_hub_tp_theme_css .='a,p.infotext,a,.main-navigation .current_page_item > a, .main-navigation .current-menu-item > a, .main-navigation .current_page_ancestor > a,.main-navigation a:hover,#theme-sidebar h3 ,#about h3, .box-content a,#slider .inner_carousel h2,#theme-sidebar h3, #theme-sidebar h1.wp-block-heading, #theme-sidebar h2.wp-block-heading, #theme-sidebar h3.wp-block-heading,#theme-sidebar h4.wp-block-heading, #theme-sidebar h5.wp-block-heading, #theme-sidebar h6.wp-block-heading,.entry-summary a, .wp-block-search .wp-block-search__label,#theme-sidebar .tagcloud a:hover, p.wp-block-tag-cloud a:hover  {';
			$gamers_hub_tp_theme_css .='color: '.esc_attr($gamers_hub_tp_color_option).';';
		$gamers_hub_tp_theme_css .='}';
	}
	//link 
	if($gamers_hub_tp_color_option_link != false){
		$gamers_hub_tp_theme_css .='a:hover,#theme-sidebar a:hover ,.social-media i:hover,#footer a:hover, .post_tag a:hover, #theme-sidebar .widget_tag_cloud a:hover {';
	...
	if($gamers_hub_tp_color_option_link != false){
		$gamers_hub_tp_theme_css .='#footer .tagcloud a:hover,.search_inner form.search-form,.post_tag a:hover, #theme-sidebar .widget_tag_cloud a:hover {';
