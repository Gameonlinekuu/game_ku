...
$gamers_hub_ids = array();
foreach( $related as $term ) {
    $gamers_hub_ids[] = $term->term_id;
}

$gamers_hub_post_args['category__in'] = $gamers_hub_ids; 

$related_posts = new WP_Query( $gamers_hub_post_args );

if ( $related_posts->have_posts() ) : ?>
        <div class="related-post-block">
        <h3 class="text-center mb-3"><?php esc_html_e('Related Posts','gamers-hub'); ?></h3>
        <div class="row">
