	...
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<div class="page-header">
				<?php if ( have_posts() ) : ?>
					<h1 class="page-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s', 'gamers-hub' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				<?php else : ?>
					<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'gamers-hub' ); ?></h1>
				<?php endif; ?>
			</div>		
			<?php
		          	...
		          	<div class="col-lg-8 col-md-8">
			            ...
			            <?php if ( have_posts() ) :
							...
							endwhile; // End of the loop.
								...
								<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'gamers-hub' ); ?></p>
								<?php
									get_search_form();
